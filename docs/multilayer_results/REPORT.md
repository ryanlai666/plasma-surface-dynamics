# Bond-resolved multilayer etching prototype
...
The baseline contains **1097 events**, removes **9 Si and 16 N**, and exposes **20 previously covered substrate atoms**. Element conservation is exact. These are simulated demonstration counts, not measurements.
...
The saved campaign produced **246 distinct missing-rate environments**, including unexecuted candidates. Twelve high-priority requests have individual folders; the full index retains all cases. A large count is evidence of unresolved parameterization, not validated mechanism completeness.

| Rank | Event | Observed executions | Sampled candidate occurrences | Request |
|---|---|---:|---:|---|
| 1 | SiN_cleavage | 0 | 4 | [IS/FS connectivity](../../data/multilayer/rate_requests/9cf19e9fdf28c3f6/request.json) |
| 2 | SiN_cleavage | 0 | 4 | [IS/FS connectivity](../../data/multilayer/rate_requests/caad422981c7be5a/request.json) |
| 3 | SiN_cleavage | 0 | 2 | [IS/FS connectivity](../../data/multilayer/rate_requests/a2f4b3715c707b60/request.json) |
| 4 | SiN_cleavage | 0 | 2 | [IS/FS connectivity](../../data/multilayer/rate_requests/f39a308898df2d66/request.json) |
| 5 | SiN_cleavage | 0 | 1 | [IS/FS connectivity](../../data/multilayer/rate_requests/15ea0df23c795c45/request.json) |
| 6 | SiN_cleavage | 0 | 1 | [IS/FS connectivity](../../data/multilayer/rate_requests/4392cf134b986b17/request.json) |
| 7 | SiN_cleavage | 0 | 1 | [IS/FS connectivity](../../data/multilayer/rate_requests/5c679a6f87523357/request.json) |
| 8 | SiN_cleavage | 0 | 1 | [IS/FS connectivity](../../data/multilayer/rate_requests/3473b3f3dd865c5e/request.json) |
| 9 | SiN_cleavage | 0 | 1 | [IS/FS connectivity](../../data/multilayer/rate_requests/015af80a808a927e/request.json) |
| 10 | HF_adsorption | 151 | 222 | [IS/FS connectivity](../../data/multilayer/rate_requests/24598d7e0e2392e2/request.json) |
| 11 | HF_adsorption | 111 | 171 | [IS/FS connectivity](../../data/multilayer/rate_requests/9f6da4820384ba7f/request.json) |
| 12 | HF_adsorption | 84 | 110 | [IS/FS connectivity](../../data/multilayer/rate_requests/c323b8983870729b/request.json) |
