# Extended project results and demonstrations
...
|---|---:|---|
| Regression suite | 57 tests passed at the first species-network release | Model checks plus path energies, geometry constraints, provenance and animation frames |
