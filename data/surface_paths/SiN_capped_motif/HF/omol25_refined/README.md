# SiN_capped_motif / HF: omol25_refined

Status: **neb unconverged; index-one candidate, connectivity unconfirmed**.

![Evaluated reaction images](path.gif)

[Every image energy](energies.csv) | [Actual coordinates](images.extxyz).

Peak relative to IS: **0.3669 (unverified peak) eV**. A peak without convergence, curvature and connectivity is not a verified transition state.
