# SiN_capped_motif / HF: omol25_neb
...
Peak relative to IS: **6.7250 (unverified peak) eV**. A peak without convergence, curvature and connectivity is not a verified transition state.
