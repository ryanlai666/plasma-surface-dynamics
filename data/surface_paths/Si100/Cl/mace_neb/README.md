...
- Numerical status: converged; maximum NEB force 0.01433 eV/angstrom.
- Peak above IS: 0.409570 eV; FS minus IS: 0.000000 eV.
- [Every image and energy](energies.csv), [coordinates and forces](images.extxyz), [full provenance](summary.json).
- Animation has 17 evaluated images, with no interpolated frames.
