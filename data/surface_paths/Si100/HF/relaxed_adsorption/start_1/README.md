# Si100 / HF - relaxed start 1

![Actual relaxation frames](relaxation.gif)

Force-converged: **True**. HF bond retained (<=1.4 A); final HF separation 0.952 angstrom. This distance classification is not a full bonding or stability analysis.

Upper-substrate maximum displacement: 0.702 angstrom. Mobile substrate atoms: 18; all HF atoms mobile.
