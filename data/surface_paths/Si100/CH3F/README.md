...
![3D evaluated approach](mace_site_orientation/hollow/upright/path.gif)
...
- Selected site/orientation: **hollow / upright**.
- Lowest sampled interaction energy: **-0.34703 eV** at 1.6 angstrom.
- Tested 9 site/orientation combinations and 81 geometries.
- [All energies](mace_site_orientation/all_energies.csv), [selected coordinates](mace_site_orientation/hollow/upright/images.extxyz), [selected provenance](mace_site_orientation/hollow/upright/summary.json).
