# alpha_quartz_001 / CH3F

![3D evaluated approach](mace_site_orientation/atop_O/flipped/path.gif)
...
- Selected site/orientation: **atop_O / flipped**.
- Lowest sampled interaction energy: **-1.01619 eV** at 1.6 angstrom.
- Tested 9 site/orientation combinations and 81 geometries.
- [All energies](mace_site_orientation/all_energies.csv), [selected coordinates](mace_site_orientation/atop_O/flipped/images.extxyz), [selected provenance](mace_site_orientation/atop_O/flipped/summary.json).
