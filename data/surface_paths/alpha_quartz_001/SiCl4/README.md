# alpha_quartz_001 / SiCl4

![3D evaluated approach](mace_site_orientation/atop_Si/flipped/path.gif)
...
- Selected site/orientation: **atop_Si / flipped**.
- Lowest sampled interaction energy: **-0.50050 eV** at 2.25 angstrom.
- Tested 9 site/orientation combinations and 81 geometries.
- [All energies](mace_site_orientation/all_energies.csv), [selected coordinates](mace_site_orientation/atop_Si/flipped/images.extxyz), [selected provenance](mace_site_orientation/atop_Si/flipped/summary.json).
