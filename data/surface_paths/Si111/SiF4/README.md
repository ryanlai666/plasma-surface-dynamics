...
![3D evaluated approach](mace_site_orientation/hollow/flipped/path.gif)
...
- Selected site/orientation: **hollow / flipped**.
- Lowest sampled interaction energy: **-1.23890 eV** at 2.75 angstrom.
- Tested 9 site/orientation combinations and 81 geometries.
- [All energies](mace_site_orientation/all_energies.csv), [selected coordinates](mace_site_orientation/hollow/flipped/images.extxyz), [selected provenance](mace_site_orientation/hollow/flipped/summary.json).
